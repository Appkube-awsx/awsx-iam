...
import (
	...
	"github.com/Appkube-awsx/awsx-iam/awssession"
...
func GetClient(region string, crossAccountRoleArn string, accessKey string,  secretKey string, externalId string) *iam.IAM{
...
func assumeRole(roleArn string, sessionName string, accesskey string, secretKey string, region string, externalId string) *iam.IAM {
	...
	clusterClient := iam.New(awsSession)
